/**
 * Calendar actions: Google Calendar OAuth, event creation, and slot queries.
 * These are actions (side-effectful) split from calendar.ts which keeps queries and mutations.
 */
