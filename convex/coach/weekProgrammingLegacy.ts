/**
 * Legacy week programming pipeline: creates week plan + pushes workouts directly to Tonal.
 * Superseded by generateDraftWeekPlan (in weekProgramming.ts) which creates drafts for review.
 */
