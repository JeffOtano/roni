...
export const metadata: Metadata = {
  ...
  description: "Terms of service for roni.coach.",
    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
        <section>
          ...
          <p>
            By creating an account or using roni.coach, you agree to these terms and our{" "}
        ...
        <section>
          ...
          <p>
            roni.coach is an independent, experimental project that provides AI-powered coaching for
            Tonal fitness machine users. It is not affiliated with, endorsed by, or connected to
        ...
        <section>
          ...
          <ul className="list-inside list-disc space-y-1">
            ...
            <li>You are responsible for the security of your roni.coach account</li>
            <li>
