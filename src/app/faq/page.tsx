...
const FAQ_CATEGORIES: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        aText:
          "Yes, an active Tonal membership is required. roni.coach uses the Tonal API to read your training data and push custom workouts to your machine. If your Tonal subscription lapses, the connection will stop working until it is renewed.",
        a: (
          <>
            Yes, an active Tonal membership is required. roni.coach uses the Tonal API to read your
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        aText:
          "No. roni.coach only reads your data and adds custom workouts to your Tonal account. It never modifies or deletes existing workouts, programs, or account settings. Custom workouts pushed by the coach appear as a separate category and can be deleted from your Tonal app at any time.",
        a: (
          <>
            No. roni.coach only reads your data and adds custom workouts to your Tonal account. It
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        aText:
          "Tonal's programs are pre-built for general audiences. roni.coach creates fully custom programs based on your data — your actual lifts, your recovery, your goals, your injuries. It also supports custom training splits and adapts week to week as your performance changes, rather than following a fixed script.",
        a: (
          <>
            Tonal&apos;s programs are pre-built for general audiences. roni.coach creates fully
  ...
  },
  {
    ...
    items: [
      {
        q: "Is roni.coach free?",
        aText:
          "Yes, roni.coach is completely free and open source. No credit card is required. All features are available to all users with no limits or hidden tiers. You bring your own Google Gemini API key (free from Google AI Studio) so the AI runs on your quota, not ours.",
        a: (
          <>
            Yes, roni.coach is completely free and open source. No credit card is required. All
      ...
      },
      {
        ...
        aText:
          "Running AI models costs real money per request. Instead of charging a subscription to cover those costs, roni.coach asks you to paste your own Google Gemini API key during onboarding. The key stays encrypted in our database and is only used to power your coaching sessions. Gemini keys are free from Google AI Studio and the free tier is generous enough for normal use.",
        a: (
          <>
            Running AI models costs real money per request. Instead of charging a subscription to
            cover those costs, roni.coach asks you to paste your own Google Gemini API key during
      ...
      {
        q: "Can I self-host roni.coach?",
        aText:
          "Yes. roni.coach is open source under the MIT license. You can clone the repository, deploy it to your own Convex + Vercel setup, and run everything under your control. The README has step-by-step instructions for getting a local or self-hosted deployment running.",
        a: (
          <>
            Yes. roni.coach is open source under the MIT license. You can clone the{" "}
            <a
              href={REPO_URL}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <main className="mx-auto max-w-3xl px-4 py-16 sm:px-8">
          <header className="mb-16 text-center">
            ...
            <p className="text-lg text-muted-foreground">
              Everything you need to know about roni.coach
            </p>
          </header>
